# -*- coding: utf-8 -*-
"""
Created on Wed Nov  8 09:15:15 2023
...
def add_player(players_list):
    ...
    with open('players_list.csv','w') as outfile_handle:
        outfile_handle.write(name)
        outfile_handle.write(position)
        outfile_handle.write(at_bats)
        outfile_handle.write(hits)
...
def display_players(players_list):
    if players_list == None:
        ...
        for i, player in enumerate(players_list, start=1):
            ...
            with open('players_list.csv','r') as outfile_handle:
               outfile_handle.readline(players_list)
        print()
